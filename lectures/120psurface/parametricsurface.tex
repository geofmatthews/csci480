...
then let $s\in[a,\ldots, b]$ and $t\in[0,2\pi]$, and the parametric
surface is
\begin{eqnarray*}
  g(s,t) &=& (s, f(s)\cos(t),  f(s)\sin(t))\\
  \frac{\partial g}{\partial s} &=& (1, f'(s)\cos(t), f'(s)\sin(t))\\
  \frac{\partial g}{\partial t} &=& (s, -f(s)\sin(t), f(s)\cos(t)\\
\end{eqnarray*}
\end{frame}
...
\item Find the normal, tangent, and binormal to the curve: $n, t,b$
