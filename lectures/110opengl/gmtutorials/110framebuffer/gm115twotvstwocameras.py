...
# using getFramebuffer function to make two tv monitors
# try changing the resolution of the framebuffer
# also try getting a fun house mirror effect by looking into
# the corner
...
# window is created
def init():
    global theMesh, theTV, theTV2, theLight, theCamera, \
