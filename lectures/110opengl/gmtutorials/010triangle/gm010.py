...
def initializeShaders():
    ...
    # Make sure the locations actually exist
...
# Also, make sure the front face is circled in a right-hand
# fashion by the vertices.
...
# Copy our data into this buffer.
# Assign the buffer to positionBufferObject 
