...
def main ():
    ...
    programID = loadProgram(
        os.path.join("shaders","shader07bumpmap.vert"),
        os.path.join("shaders","shader07bumpmap.frag")
        )
    ...
    # textures
    ColorTexture = loadTexture(os.path.join("images","brickwork-texture.jpg"))
    NormalTexture = loadTexture(os.path.join("images","brickwork_normal-map.jpg"))
    # get handles
    ColorTextureID = glGetUniformLocation(programID, "colorTexture")
    NormalTextureID = glGetUniformLocation(programID, "normalTexture")
    print "TextureIDs:", ColorTextureID, NormalTextureID
