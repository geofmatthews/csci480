...
g_instanceList = [Instance(NullRotation, translation(0,0,-25)),
                  Instance(RotateX, translation(-5,-5,-25)),
                  Instance(RotateY, translation(-5,5,-25)),
                  Instance(RotateZ, translation(5,5,-25)),
                  Instance(RotateAxis, translation(5,-5,-25))]
